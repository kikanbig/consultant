...
module.exports = {
  ...
  intents: {
    ...
    // Прямые запросы о стеллажах с номерами
    shelf_direct: [
      'что на стеллаже', 'что на стеллаже номер', 'что на стеллаже полка',
      'что на стеллаже номер полка', 'что на стеллаже полка номер',
      'что на стеллаже полка', 'что на стеллаже полка',
      'что на стеллаже', 'что на стеллаже', 'что на стеллаже'
    ],
