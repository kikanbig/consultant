...
function extractIntent(command) {
  ...
  const intents = {
    divan_search: [
      'диван', 'диваны', 'кресло', 'мебель', 'софа',
      'veluna', 'elva', 'rivalli', 'мебельград', 'mio tesoro', 'мио тесоро',
      'гизела', 'кьянти', 'вито', 'бильбао', 'пекин', 'айсти',
      'майами', 'аспен', 'асpen'
    ],
    
    matras_search: [
      'матрас', 'матрасы', 'lagoma', 'лагома',
      'laoma', 'palato', 'alma', 'asker', 'glatta', 'ilta', 'lenvik', 'lund', 'narvik', 'ulvik',
      'лаома', 'палато', 'альма', 'алма', 'аума', 'аскер', 'эскер', 'эскара', 'глатта', 'глата', 'ильта', 'илта',
